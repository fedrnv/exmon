...
id: EXM-054
title: "Protocol scenario execution engine"
type: Task
area: server
...
initial_dependencies: ["EXM-052","EXM-053"]
created_at: 2026-09-19T15:05:00Z
created_by: "Fedor and ChatGPT"
---
# EXM-054 — Protocol scenario execution engine
## Goal
Execute bounded scenarios containing send, wait, expect, delay, condition, branch, loop and timeout steps with variables and safe expressions.
## Boundaries and compatibility
No arbitrary host-code execution; loops/runtime/actions have explicit limits and cancellation.
...
| --- | --- | --- | --- |
| AC-01 | Sequential/branch/loop fixtures execute deterministically | deterministic focused/integration fixture | PASS |
| AC-02 |  timeout produces diagnostic failure | negative/integration | PASS |
| AC-03 |  cancellation stops future effects. | recovery/invariant | PASS |
