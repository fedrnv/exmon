...
id: EXM-068
title: "Add real-time windowed signal processing"
type: Task
area: server
...
initial_dependencies: ["EXM-067"]
created_at: 2026-09-19T15:55:00Z
created_by: "Fedor and ChatGPT"
---
# EXM-068 — Add real-time windowed signal processing
## Goal
Provide real-time moving/window statistics and transforms including mean, min/max, RMS, standard deviation, difference/rate, derivative, integral and configurable moving average.
## Boundaries and compatibility
Window/time semantics are explicit and numerically bounded; invalid/gapped samples have defined policy.
...
| --- | --- | --- | --- |
| AC-01 | Known vectors match tolerances | deterministic unit/integration fixture | PASS |
| AC-02 |  time/sample windows select exact inputs | integration/negative | PASS |
| AC-03 |  gaps/invalid values follow configured policy. | recovery/invariant | PASS |
